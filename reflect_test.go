...
func TestUnit_getReflectAddress2(t *testing.T) {
	...
	tests := []struct {
		...
		{name: "Case04", obj: aa("aaa"), want: "go\\.osspkg\\.com\\/grape\\.aa", ok: true},
		{name: "Case05", obj: func() *aa { a := aa("aaa"); return &a }(), want: "\\*go\\.osspkg\\.com\\/grape\\.aa", ok: true},
		{name: "Case06", obj: func() *aa { a := aa("aaa"); return &a }, want: "0x([0-9a-z]+)\\.func\\(\\) \\*grape\\.aa", ok: true},
		{name: "Case07", obj: fn1, want: "go\\.osspkg\\.com\\/grape\\.ff", ok: true},
		...
		{name: "Case13", obj: bb{}, want: "go\\.osspkg\\.com\\/grape\\.bb", ok: true},
		{name: "Case14", obj: &bb{}, want: "\\*go\\.osspkg\\.com\\/grape\\.bb", ok: true},
		...
		{name: "Case18", obj: []cc{}, want: "\\[\\]go\\.osspkg\\.com\\/grape\\.cc", ok: true},
		{name: "Case19", obj: []*cc{}, want: "\\[\\]\\*go\\.osspkg\\.com\\/grape\\.cc", ok: true},
		{name: "Case20", obj: map[cc]cc{}, want: "map\\[go\\.osspkg\\.com\\/grape\\.cc\\]go\\.osspkg\\.com\\/grape\\.cc", ok: true},
		{name: "Case21", obj: map[*cc]*cc{}, want: "map\\[\\*go\\.osspkg\\.com\\/grape\\.cc\\]\\*go\\.osspkg\\.com\\/grape\\.cc", ok: true},
		...
		{name: "Case26", obj: [2]*cc{}, want: "\\[2\\]\\*go\\.osspkg\\.com\\/grape\\.cc", ok: true},
	}
	...
	fmt.Println(got, ok)
	casecheck.Equal(t, "go.osspkg.com/grape.cc", got)
	casecheck.True(t, ok)
}
